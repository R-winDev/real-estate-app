        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center gap-2.5 group">
                        ...
                        <span class="text-lg font-extrabold text-surface-900 hidden sm:inline">املاک</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    <x-dropdown align="left" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-surface-600
                                           hover:bg-surface-100/80 hover:text-surface-900 focus:outline-none transition-all duration-200">
            ...
            <div class="-ml-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-xl text-surface-400
                                                       hover:text-surface-600 hover:bg-surface-100/80 focus:outline-none focus:bg-surface-100
                                                       focus:text-surface-600 transition-all duration-200">
