<x-admin-layout title="افزودن کاربر">
    <div class="max-w-xl">
        {{-- Page Header --}}
        <div class="mb-6">
            <h2 class="text-xl font-bold text-neutral-800">افزودن کاربر</h2>
            <p class="text-sm text-neutral-500 mt-1">کاربر جدید در سیستم ثبت کنید</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <div class="p-6 space-y-5">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <x-form-input name="email" :value="old('email')" label="ایمیل" type="email" dir="ltr" required />
                    </div>
                    <x-form-input name="phone" :value="old('phone')" label="تلفن" :optional="true" dir="ltr" />
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <x-form-input name="password" label="رمز عبور" type="password" dir="ltr" required />
                        <x-form-input name="password_confirmation" label="تکرار رمز عبور" type="password" dir="ltr" required />
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex items-center gap-6">
                        <label class="flex items-center gap-2.5 cursor-pointer group">
                            ...
                            <input type="checkbox" name="is_admin" value="1" {{ old('is_admin') ? 'checked' : '' }} class="w-4 h-4 rounded border-neutral-300 text-primary-600 focus:ring-primary-500 transition-all">
                        ...
                        <label class="flex items-center gap-2.5 cursor-pointer group">
                            ...
                            <input type="checkbox" name="must_change_password" value="1" {{ old('must_change_password') ? 'checked' : '' }} class="w-4 h-4 rounded border-neutral-300 text-primary-600 focus:ring-primary-500 transition-all">
