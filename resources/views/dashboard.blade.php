    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div class="glass rounded-2xl p-5 group hover:shadow-glow transition-all duration-300">
                ...
                <div class="glass rounded-2xl p-5 group hover:shadow-glow transition-all duration-300">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="card">
                <div class="flex justify-between items-center p-6 border-b border-surface-100">
                    ...
                    <a href="{{ route('properties.create') }}" class="btn-primary text-sm">
                ...
                @else
                    <div class="divide-y divide-surface-100">
                        @foreach($recentProperties as $property)
                            <a href="{{ route('properties.show', $property) }}" class="flex items-center gap-4 p-4 hover:bg-surface-50/80 transition-colors duration-200">
                                <div class="w-14 h-14 bg-gradient-to-br from-brand-100 to-brand-50 rounded-xl flex items-center justify-center shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-semibold text-surface-900 truncate">{{ $property->title }}</h4>
